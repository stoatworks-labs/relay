/**
    ...
    the `CFFGLPluginInfo` that Relay.cpp registers at static-initialisation
    ...
    binary: which build it is.
        ...
        strings Relay.bundle/Contents/MacOS/Relay | grep relay
*/

extern "C" const char* RelayBuildStamp()
{
	return "relay " RELAY_VERSION " built " __DATE__ " " __TIME__;
}
